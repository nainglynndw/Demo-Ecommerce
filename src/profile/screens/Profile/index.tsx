    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            {ordersLoading ? (
              <InfoRow label="Loading..." value="" theme={theme} isLast />
            ) : orders.length > 0 ? (
              <>
                {orders.slice(0, 3).map((order, index) => (
                  <InfoRow
                    ...
                    value={`${order.productName} - $${order.totalAmount.toFixed(2)}`}
                    theme={theme}
...
const InfoRow: React.FC<InfoRowProps> = ({ label, value, theme, isLast }) => {
